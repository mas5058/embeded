...
(
    ...
    localparam PAD3 = log2ceil(64'h12030 - 64'h12020); 
    localparam PAD4 = log2ceil(64'h12040 - 64'h12030); 
    ...
    localparam PAD9 = log2ceil(64'h12080 - 64'h12078); 
    // -------------------------------------------------------
    ...
    // ( 0x12020 .. 0x12030 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 17'h12020  && read_transaction  ) begin
            src_channel = 10'b1000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x12030 .. 0x12040 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 17'h12030   ) begin
    ...
    // ( 0x12070 .. 0x12078 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h12070  && read_transaction  ) begin
            src_channel = 10'b0000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x12078 .. 0x12080 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 17'h12078   ) begin
