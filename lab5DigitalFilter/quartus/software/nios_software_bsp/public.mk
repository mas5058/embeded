...
# setting SOPC_SYSID_BASE_ADDRESS is 0x12070
SOPC_SYSID_FLAG += --sidp=0x12070
ELF_PATCH_FLAG  += --sidp 0x12070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1523478419
SOPC_SYSID_FLAG += --timestamp=1523478419
ELF_PATCH_FLAG  += --timestamp 1523478419
